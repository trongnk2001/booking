...
const Header = ({type}) => {
    ...
    <div className="header">
        <div className={type === "list" ? "headerContainer listMode":"headerContainer"}>
            ...
            { type !== "list" && 
            <>
            <h1 className="headerTitle">Tận hưởng những chuyến đi !</h1>
            <p className="headerDesc">
                Nhận phần thưởng cho chuyến du lịch của bạn - tiết kiệm ngay lập tức 10% hoặc
                nhiều hơn với tài khoản Booking miễn phí
            </p>
            ...
            <div className="hearderSearch">
                ...
                <div className="headerSearchItem">
                    <button className="headerBtn" onClick={handleSearch}>Tìm</button>
                </div>
            </div>
            </>
            }
